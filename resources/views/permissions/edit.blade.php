                            ...
                            <div class="accordion">
                                @foreach($permissions as $item)
                                    ...
                                    @if(count($item['children']) > 0)
                                        <div class="card">
                                            <div class="card-header" style="padding: 5px 10px;background-color: #e6e8e7;">
                                                ...
                                                <label class="col-lg-6 col-sm-6 col-xs-12" style="float: none;">
                                                    ...
                                                    <input id="view{{ $item->menu_id }}" name="view[]" type="checkbox" value="1" onchange="chkBox('view{{ $item->menu_id }}');autoChecked('{{ $item->menu_id }}','parent')" @if(isset( $view) && $view == 1) checked="true" @endif> เปิดการใช้งาน
                                            ...
                                            <div id="{{ $item->menu_id }}-info" class="panel-collapse collapse  @if((isset( $view) && $view == 1)) in @endif">
                                                <ul class="list-group card-body" style="padding: 0">
                                                    @foreach($item['children'] as $child)
                                                        ...
                                                        <li class="list-group-item" style="display: inline-block;width: 100%;padding: 5px 10px;">
                                                            ...
                                                            <label class="col-lg-6 col-sm-6 col-xs-12" style="float: none;">
                                                                ...
                                                                <input id="view{{ $child->menu_id }}" class="childview-{{ $item->menu_id }}" name="view[]" type="checkbox" value="1" onchange="chkBox('view{{ $child->menu_id }}');autoChecked('{{ $child->menu_id }}','child','#view{{ $item->menu_id }}');" @if(isset( $view) && $view == 1) checked="true" @endif> เปิดการใช้งาน
                                        ...
                                        <div class="card">
                                            <div class="card-header" style="padding: 5px 10px;background-color: #e6e8e7;">
                                                ...
                                                <label class="control-label col-lg-6 col-sm-6 col-xs-12" style="float: none;">
                                                    <input type="hidden" id="menu_id[]" name="menu_id[]" value="{{ $item->menu_id }}">
                                                    <input id="view{{ $item->menu_id }}" name="view[]" type="checkbox" value="1" onchange="chkBox('view{{ $item->menu_id }}');autoChecked('{{ $item->menu_id }}');" @if(isset( $view) && $view == 1) checked="true" @endif> เปิดการใช้งาน
                                                    <input id="view{{ $item->menu_id }}-hidden" name="view[]" type="hidden" value="0" @if(isset( $view) && $view == 1) disabled="true" @endif>
                                                </label>
                                            </div>
                                        </div>
