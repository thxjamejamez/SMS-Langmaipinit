            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-1">
                        ...
                        <input id="creditcompany" type="text" class="form-control" name="creditcompany" @if(isset($editprofile->company_credit)) value="{{$editprofile->company_credit}}" @endif @if($permission->permission_id != 1) readonly @endif>
                    </div>
                </div>
            <div class="row">
                <div class="form-group col-2">
